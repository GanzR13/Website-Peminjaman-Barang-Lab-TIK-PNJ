        ...
        <transition name="fade">
            <div v-if="isOpen" class="fixed inset-0 z-999 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4" @click.self="closeModal">
                ...
                <div class="bg-white rounded-3xl shadow-2xl w-full max-w-4xl p-0 overflow-hidden relative flex flex-col max-h-[95vh] lg:max-h-[70vh]">
                    ...
                    <form @submit.prevent="submitLapor" class="grid grid-cols-1 lg:grid-cols-12 gap-0 w-full h-full overflow-y-auto lg:overflow-hidden custom-scrollbar">
                        ...
                        <div class="lg:col-span-7 flex flex-col relative bg-white lg:max-h-[70vh] lg:overflow-y-auto custom-scrollbar">
                            ...
                            <div class="p-6 md:p-8 pb-4 border-b border-slate-100 sticky top-0 bg-white/95 backdrop-blur-md z-10 flex justify-between items-start shrink-0">
                                ...
                                <button type="button" @click="closeModal" class="p-2 bg-slate-50 hover:bg-red-50 text-slate-400 hover:text-red-500 rounded-full transition-colors cursor-pointer shrink-0 active:scale-95" title="Tutup">
                            ...
                            <div class="p-6 md:p-8 border-t border-slate-100 bg-white/95 backdrop-blur-md sticky bottom-0 z-10 shrink-0 flex gap-4">
                                <button type="button" @click="closeModal" class="px-6 py-4 bg-slate-100 text-slate-600 font-black rounded-2xl hover:bg-slate-200 transition-colors cursor-pointer text-base shrink-0 active:scale-95">
                                    Batal
                                </button>
