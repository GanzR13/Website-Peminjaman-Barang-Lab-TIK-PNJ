  ...
  <aside class="w-64 bg-slate-900 text-white h-full flex flex-col shadow-2xl shrink-0">
    <div class="p-6 text-xl font-bold border-b border-slate-800 flex items-center justify-between shrink-0">
      <div class="flex items-center space-x-3">
        ...
        <span class="tracking-wide text-lg">SI-LAB <span class="text-blue-400">Admin</span></span>
      </div>
    </div>
    ...
    <div class="p-4 border-t border-slate-800 shrink-0">
      <button @click="handleLogout"
        ...
        <svg class="w-5 h-5 shrink-0 transition-transform group-hover:-translate-x-1" fill="none" stroke="currentColor"
          viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
